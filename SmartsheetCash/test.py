...
while True:
    ...
    print("Upload file: " + str(currentTime))

    session = ftplib.FTP('ftp.savarti.com','qa_test','svi4ams!')

    file = open('C:\\CAD\\GIT\\SVI_Smartsheet\\SmartsheetCash\\sample\\data\\workspace\\SmartsheetCash.log','rb')           # file to send

    session.storbinary('STOR /tools/windows2linux/test_ftp/networkMonitor/SmartsheetCash.log', file)     # send the file
